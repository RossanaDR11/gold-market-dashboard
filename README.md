...
- Current gold price
- Daily change
- RSI indicator (momentum signal)
- Historical performance (YTD, long-term returns)
- Moving averages (MA50 and MA200) to identify market trends
2. Risk Analysis
- Volatility metrics
- All-Time High price
- 10-Year Low price
- Volatility visualization to highlight periods of market uncertainty

**Tools Used**
- Power BI Desktop
- Financial time-series data
- DAX measures for performance and risk metrics

**Collaboration**
This project was developed in collaboration with Mariela Palmieri, focusing on financial data analysis and dashboard design.
